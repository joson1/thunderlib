 ...
 * r1 --> to
 */
.global cpu_hw_context_switch_interrupt
.type cpu_hw_context_switch_interrupt, %function
.global cpu_hw_context_switch
.type cpu_hw_context_switch, %function

cpu_hw_context_switch_interrupt:
cpu_hw_context_switch:
    /* set cpu_thread_switch_interrupt_flag to 1 */
...
.type cpu_hw_context_switch_to, %function

cpu_hw_context_switch_to:
    LDR r1, =cpu_interrupt_to_thread
    STR r0, [r1]
    ...
    LDR r1, =cpu_interrupt_from_thread
    MOV r0, #0x0
    STR r0, [r1]

    /* set interrupt flag to 1 */
    LDR     r1, =cpu_thread_switch_interrupt_flag
    MOV     r0, #1
    STR     r0, [r1]
...
PendSV_Handler:
    ...
    /* get cpu_thread_switch_interrupt_flag */
    LDR r0, =cpu_thread_switch_interrupt_flag
    LDR r1, [r0]
    CBZ r1, pendsv_exit         /* pendsv already handled */

    /* clear cpu_thread_switch_interrupt_flag to 0 */
    MOV r1, #0x00
    STR r1, [r0]

    LDR r0, =cpu_interrupt_from_thread
    LDR r1, [r0]
